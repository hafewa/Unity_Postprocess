...
namespace PostProcess
{
	...
	public class GodRayController : MonoBehaviour
    {
        ...
        private void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            this.material.SetVector(THRESHOLD_ID, colorThreshold);
            this.material.SetVector(LIGHTPOS_ID, new Vector4(viewPortLightPos.x, viewPortLightPos.y, viewPortLightPos.z, 0));
            this.material.SetFloat(RADIUS_IS, lightRadius);
            this.material.SetFloat(POWFACTOR_ID, lightPowFactor);
            this.material.SetFloat(DEPTH_THRESHOLD_ID, depthThreshold);
            Graphics.Blit(source, temp1, this.material, 0);
            ...
            for (int i = 0; i < blurIteration; ++i)
            {
                ...
                this.material.SetVector(OFFSET_ID, new Vector4(offset, offset, 0, 0));
            ...
            this.material.SetTexture(BLURTEX_ID, temp1);
            this.material.SetVector(LIGHTCOLOR_ID, lightColor);
            this.material.SetFloat(LIGHTFACTOR_ID, lightFactor);
